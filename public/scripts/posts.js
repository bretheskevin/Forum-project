...
for (let like of likes) {
    if (like.parentNode.parentNode === document.getElementById("disable-like-dislike")) { //dashboard
        makeLikeGreen(like);
        like.classList.remove("cursor-pointer");
    } else {
        like.addEventListener("click", () => { //homepage
            makeLikeGreen(like);
...
for (let dislike of dislikes) {
    if (dislike.parentNode.parentNode.classList.contains("disable-like-dislike")) { //dashboard
        makeDislikeRed(dislike);
        dislike.classList.remove("cursor-pointer");
