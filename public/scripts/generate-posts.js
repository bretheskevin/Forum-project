...
likeSvgGrey = "<svg width=\"30\" height=\"30\" viewBox=\"0 0 14 30\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
    ...
    "                                    </svg>"
dislikeSvgGrey = "<svg width=\"30\" height=\"30\" viewBox=\"0 0 14 30\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
...
function createPost() {
    ...
    post.appendChild(createHeader());
    post.appendChild(createContent());
    post.appendChild(createFooter());
